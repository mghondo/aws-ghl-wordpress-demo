  ...
  <footer id="footer" class="footer position-relative dark-background">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span><?php esc_html_e('Copyright', 'clarity-aws-ghl'); ?></span> <strong class="px-1 sitename"><?php bloginfo('name'); ?></strong> <span><?php esc_html_e('All Rights Reserved', 'clarity-aws-ghl'); ?></span></p>
      <p class="credits">
        <?php
        printf(
