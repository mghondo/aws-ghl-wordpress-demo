<?php
/**
 * Single Course Template - Updated to match page-course.php layout
 * Template for displaying individual course pages with beautiful purple gradient hero
 * 
...
// Get course slug for compatibility with theme template
$course_slug = $clarity_course->course_slug;
$course = $clarity_course;
...
<style>
/* Course Viewer Styles - Copied from page-course.php */
...
<script>
// Copy all JavaScript from page-course.php for modal functionality
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add remaining JavaScript event listeners from page-course.php...
    // [The rest of the JavaScript would continue here]
...
// Certificate generation function (simplified)
